  ...
  $(document).ready(function() {
    ...
    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
      ...
      <div>
            ...
            ?>
      		...
      		<div style="float:left;width:730px">
        		<div class="w3-container"  style="float:left;margin-left:250px;margin-top:120px">
        		  <h2>HR Details</h2></br>
              <p><i class="fa fa-user-circle fa-fw w3-margin-right w3-large w3-text-teal" aria-hidden="true"></i><b>NAME : </b><?php echo " ".$row1['HRname'];?></p>
              <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i><b>EMAIL : </b><?php echo " ".$row1['email'];?></p>
              <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i><b>CONTACT : </b><?php echo " ".$row1['contact'];?></p>
              <p><i class="fa fa-linkedin-square fa-fw w3-margin-right w3-large w3-text-teal" aria-hidden="true"></i><b>LINKEDIN PROFILE : </b><?php echo " ".$row1['linkedin'];?></p>
              <hr>
            </div>
          </div>
          ...
          <center><a href="c_updt.php"><button style="border:1px solid grey;margin-top:50px;" class="button button2">UPDATE INFO</button></a></center>
  </div>
