...
<body data-spy="scroll" data-target=".navbar" data-offset="50" style = "background-image: url('https://ak4.picdn.net/shutterstock/videos/1143424/thumb/1.jpg' );background-position: center;background-repeat: no-repeat;background-size: cover;">
    ...
    $connect=mysqli_connect('localhost','ritesh1203','');
      ...
      //echo "Key: $key; Value: $value\n";}
		...
		<div class="pic"  id="info1" style="margin-left:300px;margin-top:210px ">
			...
			<a href="s_updt.php"><button style="border:1px solid grey;" class="button button2">UPDATE INFO</button></a>
		</div>
		
    <div class="w3-container" id="info" style="margin-top:130px;height=80%;">
      ...
      <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-large w3-text-teal" aria-hidden="true"></i><b>DATE OF BIRTH : </b><?php echo " ".date("d F Y", strtotime($row['dob']));?></p>
