...
$query = "select website as Website from temp_Company_details";
...
if(@mysqli_num_rows($query_run)>0)
{
    ...
    <?php echo '<p style = "text-align:center;color:#fff;">Company Requests'?>
    <thead>
        <tr>
            <th>Company</th>
            <th>Accept</th>
    ...
    while($row = mysqli_fetch_assoc($query_run)){
        ...
        echo "<tr>
                ...
                <td>
                <form action=".'"comappr.php" method = "POST">'."
                <input type=".'"submit" style="color:black;height:100%;width:100%;background-color: #ffffff;" value="Accept" name = "'.$row['Website'].'">
                </td>
                ...
                <td>
                <form action="comappr.php" method = "POST">
                <input type="submit" style="color:black;height:100%;width:100%;background-color: #ffffff;" value="Reject" name = "'.$row['Website'].'">
                </td>
                <input type="hidden" name="type" value="Reject"/>
                <input type="hidden" name="website" value="'.$row['Website'].'"/>
                </form>
                <td>
                <form action="temp_prof.php" method = "POST">
                <input type="submit" style="color:black;height:100%;width:100%;background-color: #ffffff;" value="View" name = "'.$row['Website'].'">
                </td>
                <input type="hidden" name="website" value="'.$row['Website'].'">
                </form>
