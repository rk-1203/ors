...
$_SESSION['flagc']=0;
if(!empty($_SESSION['hrname']))
  header('Location: ../Dashboards/company.php');
?>

<body>
  <!-- multistep form -->
  <form id="msform" action="c_check.php" method="POST">
    <fieldset>
      <h1 class="fs-title" style="font-size: 25px">Company Log In</h1>
      <input type="text" name="username" value = "<?php if(isset($_POST['username'])) echo $_POST['username']; ?>" placeholder="Company Website" />
      ...
      <p><a href="..\..\Project\Company\register.php" style="text-decoration: none; padding: 0px 5px; float:right" >New User</a><i class="fa fa-user" style="float: right; font-size:16px;color:red;"></i></p>
    </fieldset>
  </form>
